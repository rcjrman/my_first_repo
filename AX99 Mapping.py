...
for entry in my_file:
	...
	a = my_df[['DIE_X','DIE_Y']]\
		...
		[my_df['OSC_Code'] == 123]\
		[my_df['I_Gain_Coarse_Code'] == 17]\
		[my_df['I_Gain_Fine_Code'] == 1]\
		[my_df['V_REF_Code'] == 5]\
        ...
        [my_df['BCNTIV_Code'] == 0]\
        [my_df['Spkr_VOS_Code'] == 2]\
        [my_df['VOS_D_Code'] == 6]\
        [my_df['IV_XtalkCoarse_Code'] == 2]\
        [my_df['IV_XtalkFine_Code'] == 3]\
        [my_df['BOOST_ZC_Code'] == 0]\
        [my_df['BOOST_REF_Code'] == 1]\
        [my_df['Ilim_Gain_Code'] == 0]\
        [my_df['Ilim_Offset_Code'] == 48]\
        [my_df['ALCEN_Option'] == 1]\
        [my_df['REV_ID_ILIM_Code'] == 0]\
        [my_df['PreampOffsetAnalogMode'] == 5]
